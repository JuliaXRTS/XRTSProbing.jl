    ...
    @testset "n: $N" for N in NNODES
        ...
        @testset "single" begin
            ...
            @testset "bounds" begin
                test_u = rand(RNG)
                test_x = XRTSProbing._vegas_map(test_vg, test_u)
                @test LOW <= test_x <= UP
            end
            ...
            @testset "on nodes" begin
                for i in 1:nbins(test_vg)
                    ...
                    test_x = XRTSProbing._vegas_map(test_vg, u_on_node)
        ...
        @testset "multiple" begin
            ...
            @testset "bounds" begin
                ...
                test_x_vec = XRTSProbing._vegas_map(test_vg, test_u_vec)
            ...
            @testset "on nodes" begin
                for i in 1:nbins(test_vg)
                    ...
                    test_x_vec = XRTSProbing._vegas_map(test_vg, u_on_node)
