    ...
    @testset "n: $N" for N in NNODES
        ...
        @testset "single" begin
            for i in 1:nbins(test_vg)
                ...
                test_jac = XRTSProbing._jac_vegas_map(test_vg, u_on_node)
        ...
        @testset "multiple" begin
            for i in 1:nbins(test_vg)
                ...
                test_jac_vec = XRTSProbing._jac_vegas_map(test_vg, u_on_node)
        ...
        @testset "sum rule" begin
            test_sum = sum(
                [
                    spacing(test_vg, i) /
                        XRTSProbing._jac_vegas_map(test_vg, (i - 1) / nbins(test_vg)) for
...
@testset "ndims: $DIM" for DIM in DIMS
    ...
    @testset "n: $N" for N in NNODES
        ...
        @testset "sum rule" begin
            test_jac_on_nodes = XRTSProbing._jac_vegas_map(
                test_vg,
